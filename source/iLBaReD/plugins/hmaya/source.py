...
async def alive(client: Client, message):
    ...
    alive = f"""╭──── • ◈ • ────╮
么 [𝑫𝒆𝒗 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/DEV_ADRENALEN).
么 [𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆](WA_ADRENALEN).
么 [𝑮𝒓𝒐𝒖𝒑 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/BAR_ADRENALEN).
╰──── • ◈ • ────╯
🚦𝑻𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 ."""

    await message.reply_photo(
        photo=f"https://t.me/SOURCE_BOYKA/41",
        caption=alive,
        reply_markup=keyboard,
    )

@Client.on_message(filters.command(["المطور عمر","عمورا","المبرمج"], ""))
async def deev(client: Client, message: Message):
     if await joinch(message):
            return
     user = await client.get_chat(chat_id="DEV_ADRENALEN")
