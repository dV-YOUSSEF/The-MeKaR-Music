...
[InlineKeyboardButton("صاحب السورس 🧑‍✈️", url=f"https://t.me/DEV_ADRENALEN")],
[InlineKeyboardButton("طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("جروب البوت 🤖", url=f"https://t.me/BAR_ADRENALEN"),InlineKeyboardButton("قناه التحديثات 🐉", url=f"https://t.me/WA_ADRENALEN")],
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ [{OWNER_NAME}]""",
        ...
        reply_markup=InlineKeyboardMarkup([
[InlineKeyboardButton("The owner of the source 🧑‍✈️", url=f"https://t.me/DEV_ADRENALEN")],
...
[InlineKeyboardButton("Bot Group 🤖", url=f"https://t.me/BAR_ADRENALEN"),InlineKeyboardButton("Channel Updates 🐉", url=f"https://t.me/WA_ADRENALEN")],
[InlineKeyboardButton(f"{devname}", user_id=f"{dev}")],
