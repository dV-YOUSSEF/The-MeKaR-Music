...
ahmed = "https://telegra.ph/file/a982187bd0641ac430c78.jpg"
...
async def welcome(client: Client, message):
   try:
    ...
    if message.new_chat_members[0].username == "DEV_ADRENALEN":
      try:
         ...
         await client.set_administrator_title(chat_id, user_id, "عمر")
      except:
        pass
      return await message.reply_text(f"**انضم المطور عمر للشات .\nمرحبا بك : @DEV_ADRENALEN .**")
