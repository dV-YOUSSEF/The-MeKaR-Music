...
from iLBaReD.utils import AdminRightsCheck
from iLBaReD.utils.database import is_active_chat, is_nonadmin_chat
from iLBaReD.utils.decorators.language import languageCB
from iLBaReD.utils.inline import close_markup, speed_markup
from config import BANNED_USERS, adminlist

checker = []


@app.on_message(filters.command(["تغير سرعة التشغيل","تغير السرعة","تغير السرعه"],"") & ~BANNED_USERS)
